                ...
                <tr>
                    <td style="padding: 0;">
                        <table style="border-collapse: collapse; width: 100%;">
                            <tbody>
                                <tr>
                                    <td align="center" style="background: {{ resolve_theme_color(setting('cynoebook_mail_theme')) }};">
                                        @if (is_null($logo))
                            ...
                            <tr>
                                <td style="padding: 0;">
                                    <h4 style="font-family: 'Open Sans', sans-serif;
                                            ...
                                            color: #555555;"
                                    >
                                        {{ trans('cynoebook::mail.hello', ['name' => $user->first_name]) }}
                                    </h4>
                                </td>
                            </tr>
                            ...
                            <tr>
                                <td align="center" style="padding: 30px 0;">
                                    <a href="{{ $url }}" style="font-family: 'Open Sans', sans-serif;
                                                                ...
                                                                background: {{ resolve_theme_color(setting('cynoebook_mail_theme')) }};
                                                                color: #fafafa;
                                                                padding: 11px 30px;
                                                                border: none;
                                                                border-radius: 3px;
                ...
                <tr>
                    <td align="center" style="padding: 15px 0; background: #f1f3f7;">
                        ...
                        >
                            ...
                            {{ trans('cynoebook::mail.all_rights_reserved') }}
                        </span>
                    </td>
                </tr>
            </tbody>
